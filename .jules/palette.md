...
## 2024-05-24 - Dynamic Markdown replacement for WhatsApp
**Learning:** Standard AI-generated Markdown bolding (`**bold**`) breaks and displays as literal asterisks in n8n headless AI workflows targeting WhatsApp.
**Action:** Improve the micro-UX by dynamically replacing standard Markdown with WhatsApp's native single-asterisk bolding in the outbound message payload.
